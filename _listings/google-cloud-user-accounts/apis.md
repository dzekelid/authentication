...
created: "2018-02-24"
modified: "2018-02-24"
url: https://raw.githubusercontent.com/streamdata-gallery/authentication/master/_listings/google-cloud-user-accounts/apis.yaml
...
- name: Google Cloud User Accounts API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/authentication/master/_listings/google-cloud-user-accounts/project-zones-zone-linuxaccountviews-post.md
x-common:
- type: x-code
